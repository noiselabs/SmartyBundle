        ...
        if ($repeat)
        {
            ...
            if ($debug)
            {
                ...
                if (isset($config->site_url))
                    $template->assign($asset_url, $config->site_url . '/' . $build_path . '/' . $assetsUrls[$count - 1]);
                else
                    $template->assign($asset_url, '/' . $build_path . '/' . $assetsUrls[$count - 1]);
            ...
            {
                $template->assign(
                        $asset_url, (isset($config->site_url) ? $config->site_url : '') . '/' . $build_path . '/' . $assetCollection->getTargetPath());
            }
        }
