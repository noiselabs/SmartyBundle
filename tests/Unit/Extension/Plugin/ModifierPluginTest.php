...
class ModifierPluginTest extends TestCase
{
    public function testGetType()
    {
        $nullExtension = new NullExtension();
        $modifierPlugin = new ModifierPlugin('test', $nullExtension, 'none');
        $this->assertSame(AbstractPlugin::TYPE_MODIFIER, $modifierPlugin->getType());
    }
}
