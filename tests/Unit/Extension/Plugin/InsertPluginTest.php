...
use NoiseLabs\Bundle\SmartyBundle\Extension\Plugin\InsertPlugin;
use NoiseLabs\Bundle\SmartyBundle\Tests\Unit\Extension\NullExtension;
use PHPUnit\Framework\TestCase;

class InsertPluginTest extends TestCase
{
    public function testGetType()
    {
        $nullExtension = new NullExtension();
        $insertPlugin = new InsertPlugin('test', $nullExtension, 'none');
        $this->assertSame(AbstractPlugin::TYPE_INSERT, $insertPlugin->getType());
    }
}
