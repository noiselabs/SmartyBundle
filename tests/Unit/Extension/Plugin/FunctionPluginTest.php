...
class FunctionPluginTest extends TestCase
{
    public function testGetType()
    {
        $nullExtension = new NullExtension();
        $functionPlugin = new FunctionPlugin('test', $nullExtension, 'none');
        $this->assertSame(AbstractPlugin::TYPE_FUNCTION, $functionPlugin->getType());
    }
}
